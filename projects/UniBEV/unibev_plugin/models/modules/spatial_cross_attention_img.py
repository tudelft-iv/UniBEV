...
class SpatialCrossAttentionImg(BaseModule):
    """An attention module used in uniBEV.
    Args:
    ...
    def __init__(self,
        ...
        super(SpatialCrossAttentionImg, self).__init__(init_cfg)
    ...
    def forward(self,
        ...
        # ## debug
        # print('\nIn Spatial Cross Attention')
        # print('bev_mask:', bev_mask.size()) # (6,1,22500,4)
        # print('query:', query.size()) # (1, 22500, 256)
        # print('key:', key.size()) # (6, 920, 1, 256)
        # print('value:', value.size()) # same as key: (6, 920, 1, 256)
        # print('query pose:', query_pos) # None
        # print('reference points cam:', reference_points_cam.size()) # (6, 1, 22500, 4, 2)
        # ##
...
@ATTENTION.register_module()
class MSDeformableAttention3DImg(BaseModule):
    ...
    def forward(self,
        ...
        # ## debug
        # print('\nIn MSDeformableAttention3DVoxelDETR:')
