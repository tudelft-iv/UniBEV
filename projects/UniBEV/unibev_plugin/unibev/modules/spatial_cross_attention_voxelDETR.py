...
class SpatialCrossAttentionVoxelDETR(BaseModule):
    ...
    def __init__(self,
        ...
        super(SpatialCrossAttentionVoxelDETR, self).__init__(init_cfg)
...
@ATTENTION.register_module()
class MSDeformableAttention3DVoxelDETR(BaseModule):
