...
class UniqueryDETR_PtsEncoder(TransformerLayerSequence):
    ...
    def __init__(self, *args,
        ...
        super(UniqueryDETR_PtsEncoder, self).__init__(*args, **kwargs)
    ...
    def forward(self,
        ...
        reference_points_lidar, bev_mask_lidar = self.point_sampling(ref_3d_lidar, self.pc_range, feat_type='lidar')
...
class UniQueryDETR_PtsLayer(BaseTransformerLayer):
    ...
    def __init__(self,
                 ...
                 ffn_num_fcs=2,
                 **kwargs):
        super(UniQueryDETR_PtsLayer, self).__init__(
            attn_cfgs=attn_cfgs,
