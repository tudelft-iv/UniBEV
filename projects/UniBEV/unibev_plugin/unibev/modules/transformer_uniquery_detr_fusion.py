...
from .spatial_cross_attention_uniquery_img import MSDeformableAttention3DUniQueryImg
from .spatial_cross_attention_uniquery_pts import MSDeformableAttention3DUniQueryPts
...
class UniQueryTransformer(BaseModule):
    """Implements the UniQuery transformer, based on Detr3D transformer.
    Args:
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(UniQueryTransformer, self).__init__(**kwargs)
    ...
    def init_layers(self):
        """Initialize layers of the UniQueryTransformer, based on DETR3D."""
    ...
    def init_weights(self):
        ...
        for m in self.modules():
            if isinstance(m, MSDeformableAttention3DUniQueryPts) or isinstance(m, MSDeformableAttention3DUniQueryImg) \
