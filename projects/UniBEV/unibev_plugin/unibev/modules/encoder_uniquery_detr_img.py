...
class UniqueryDETR_ImgEncoder(TransformerLayerSequence):
    ...
    def __init__(self,
        ...
        super(UniqueryDETR_ImgEncoder, self).__init__(*args, **kwargs)
...
class UniQueryDETR_ImgLayer(BaseTransformerLayer):
    ...
    def __init__(self,
                 ...
                 ffn_num_fcs=2,
                 **kwargs):
        super(UniQueryDETR_ImgLayer, self).__init__(
            attn_cfgs=attn_cfgs,
