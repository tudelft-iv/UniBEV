...
class SpatialCrossAttentionUniQueryImg(BaseModule):
    ...
    def __init__(self,
        ...
        super(SpatialCrossAttentionUniQueryImg, self).__init__(init_cfg)
...
@ATTENTION.register_module()
class MSDeformableAttention3DUniQueryImg(BaseModule):
