...
class BEVVoxelDETREncoder(TransformerLayerSequence):
    ...
    def __init__(self, *args, pc_range=None, num_points_in_pillar=4, return_intermediate=False, dataset_type='nuscenes',
        ...
        super(BEVVoxelDETREncoder, self).__init__(*args, **kwargs)
    ...
    def point_sampling(self, reference_points, pc_range):
        ...
        # ## debug, in encoder point sampling
        # print('In encoder, point sampling:')
        # print(' reference points size:', reference_points.size()) # (2,4,40000,3)
        # ##
        ...
        reference_points = reference_points[...,:2] #[4, 2, 40000,2]
    ...
    def forward(self,
        ...
        reference_points_lidar = self.point_sampling(ref_3d, self.pc_range)
...
class BEVVoxelDETRLayer(MyCustomBaseTransformerLayer):
    ...
    def __init__(self,
                 ...
                 ffn_num_fcs=2,
                 **kwargs):
        super(BEVVoxelDETRLayer, self).__init__(
            attn_cfgs=attn_cfgs,
