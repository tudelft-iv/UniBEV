...
class BEVFormerEncoderDeformable(TransformerLayerSequence):
    ...
    def __init__(self, *args, pc_range=None,
                 num_points_in_pillar=4,
                 return_intermediate=False,
                 dataset_type='nuscenes',
                 **kwargs):

        super(BEVFormerEncoderDeformable, self).__init__(*args, **kwargs)
    ...
    def get_reference_points(H,
        ...
        if dim == '3d':
            ...
            # ## debug
            # print('ref 3d expand:',ref_3d.size())
            # ##
    ...
    def point_sampling(self, reference_points, pc_range,  img_metas):
        ...
        #       'lidar2img shape:', lidar2img.shape,
        #       'lidar2img:', lidar2img)
        # ##
        ...
        # ## debug: check the value of reference points in camera 3d coordinates
        # print('\nreference points camera in encoder:', reference_points_cam.size())
        # # print(reference_points_cam)
        # ## reference points cam size: (4, 1, 6, 22500, 4) (num_in_pillar, bs, num_cam, bev_h x bev_w, (x, y, z, 1))

        bev_mask = (reference_points_cam[..., 2:3] > eps)

        # ## debug
        # print('original bev mask size:', bev_mask.size())
        # ## original bev mask size: (4, 1, 6, 22500, 1)
        ...
        # ## debug: img_shape in imge_metas:
        # print('Xs(W) corresponds: ', img_metas[0]['img_shape'][0][1],
        #       'Ys(H) corresponds: ', img_metas[0]['img_shape'][0][0],
        #       'reference_points_cam size: ', reference_points_cam.size(),
...
class BEVFormerLayerDeformable(MyCustomBaseTransformerLayer):
    ...
    def __init__(self,
                 ...
                 ffn_num_fcs=2,
                 **kwargs):
        super(BEVFormerLayerDeformable, self).__init__(
            attn_cfgs=attn_cfgs,
