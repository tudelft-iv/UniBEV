...
class SpatialCrossAttentionUniQueryPts(BaseModule):
    ...
    def __init__(self,
        ...
        super(SpatialCrossAttentionUniQueryPts, self).__init__(init_cfg)
...
@ATTENTION.register_module()
class MSDeformableAttention3DUniQueryPts(BaseModule):
