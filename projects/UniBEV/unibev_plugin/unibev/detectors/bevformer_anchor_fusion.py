...
class BEVFormerAnchorFusion(MVXTwoStageDetector):
    """
    ...
    def __init__(self,
        ...
        super(BEVFormerAnchorFusion, self).__init__(pts_voxel_layer, pts_voxel_encoder,
    ...
    def forward_train(self,
        ...
        pts_feats = [self.reduc_conv(torch.cat([img_bev_feats, pts_feats[0]], dim=1))]
